...
<template>
  <div v-if="pageCount > 1" class="sugar-pagination" :class="{ 'is-background': background, 'sugar-pagination--small': small }">
    <!-- Prev -->
    <button type="button" class="btn-prev" :disabled="innerCurrentPage <= 1" @click="prev">
    ...
    <ul class="sugar-pager">
      ...
      >
        ...
        <template v-else>
          <svg v-if="page === 'more-prev'" class="icon-more" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em">
            <path
              fill="currentColor"
              d="M529.408 149.376a29.12 29.12 0 0 1 41.728 0 30.592 30.592 0 0 1 0 42.688L259.264 511.936l311.872 319.936a30.592 30.592 0 0 1-.512 43.264 29.12 29.12 0 0 1-41.216-.512L197.76 534.272a32 32 0 0 1 0-44.672l331.648-340.224zm256 0a29.12 29.12 0 0 1 41.728 0 30.592 30.592 0 0 1 0 42.688L515.264 511.936l311.872 319.936a30.592 30.592 0 0 1-.512 43.264 29.12 29.12 0 0 1-41.216-.512L453.76 534.272a32 32 0 0 1 0-44.672l331.648-340.224z"
            />
          </svg>
          <svg v-else-if="page === 'more-next'" class="icon-more" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" width="1em" height="1em">
            <path
              fill="currentColor"
              d="M452.864 149.312a29.12 29.12 0 0 1 41.728.064L826.24 489.664a32 32 0 0 1 0 44.672L494.592 874.624a29.12 29.12 0 0 1-41.728 0 30.592 30.592 0 0 1 0-42.752L764.736 512 452.864 192a30.592 30.592 0 0 1 0-42.688m-256 0a29.12 29.12 0 0 1 41.728.064L570.24 489.664a32 32 0 0 1 0 44.672L238.592 874.624a29.12 29.12 0 0 1-41.728 0 30.592 30.592 0 0 1 0-42.752L508.736 512 196.864 192a30.592 30.592 0 0 1 0-42.688z"
            />
          </svg>
          <svg class="icon-more-text" viewBox="0 0 1024 1024" width="1em" height="1em">
            <path
              fill="currentColor"
    ...
    <!-- Next -->
    <button type="button" class="btn-next" :disabled="innerCurrentPage >= pageCount" @click="next">
      <svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em">
        <path
          fill="currentColor"
    ...
    <span v-if="layout.includes('jumper')" class="sugar-pagination__jump">
      <span style="margin-right: 4px; white-space: nowrap">{{ i18n.goTo }}</span>
      <div class="sugar-input sugar-pagination__editor is-in-pagination">
        <div class="sugar-input__wrapper">
          <input class="sugar-input__inner" type="number" :min="1" :max="pageCount" :value="innerCurrentPage" @change="handleJumperChange" />
        </div>
      </div>
    </span>
  </div>
...
.sugar-pagination--small .btn-prev,
.sugar-pagination--small .btn-next,
.sugar-pagination--small .sugar-pager li {
  height: 24px;
  line-height: 24px;
  min-width: 24px;
  font-size: 12px;
...
.sugar-pagination.is-background .btn-prev,
.sugar-pagination.is-background .btn-next,
.sugar-pagination.is-background .sugar-pager li {
...
.sugar-pagination.is-background .btn-prev:disabled,
.sugar-pagination.is-background .btn-next:disabled {
  color: var(--vp-c-text-3);
  background-color: var(--vp-c-bg-alt);
}
...
.sugar-input__inner::-webkit-outer-spin-button,
.sugar-input__inner::-webkit-inner-spin-button {
  -webkit-appearance: none;
  margin: 0;
}
